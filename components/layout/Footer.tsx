...
export function Footer() {
  ...
  return (
    <footer className="relative bg-black text-gray-300 py-12 sm:py-16 lg:py-20 w-[95%] mx-auto rounded-xl min-h-[90vh] flex flex-col mb-6 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex-1 flex flex-col relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-12 mb-12">
          ...
          <div className="space-y-6">
            <p className="text-base sm:text-lg text-gray-300 font-body leading-relaxed max-w-lg">
      ...
      {/* Large Logo */}
      <div className="flex-1 flex items-center justify-start mb-12 lg:mb-16 py-8 lg:py-16">
          <div className="w-full px-4 lg:px-8">
            <Image
              ...
              width={1004}
              height={291}
              className="w-full h-auto max-h-[250px] sm:max-h-[350px] lg:max-h-[500px] xl:max-h-[600px] object-contain"
              priority
            />
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-center text-sm text-gray-500 font-body">
            © {currentYear} HIC Tech Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
