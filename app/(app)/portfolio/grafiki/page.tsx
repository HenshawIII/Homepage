        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="space-y-6 mb-8">
            ...
            <p className="text-lg sm:text-xl text-gray-700 font-body leading-relaxed max-w-4xl">
              Grafiki is a creative agency focused on African storytelling through design and digital experiences. The goal was to build a website that clearly communicated the agency's ethos while supporting internal operations as the business grew.
            </p>
          </div>
          ...
          <div className="max-w-4xl">
            ...
            <div className="mt-8 space-y-3">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start">
                  <span className="text-[#216299] mr-2 mt-1">•</span>
                  <span className="text-base text-gray-700 font-body">Customer Service Automation</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#216299] mr-2 mt-1">•</span>
                  <span className="text-base text-gray-700 font-body">Digital Systems Support</span>
                </li>
              </ul>
            </div>
          </div>
